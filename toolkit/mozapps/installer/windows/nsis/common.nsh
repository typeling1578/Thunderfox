...
!macro GetCommonDirectory
  ...
  !ifndef ${_MOZFUNC_UN}GetCommonDirectory
    ...
    Function ${_MOZFUNC_UN}GetCommonDirectory
      ...
      StrCpy $0 "$0\typeling1578-1de4eec8-1241-4177-a864-e594e8d1fb38"
 ...
 *          Usually "Software\typeling1578\${AppName}"
 * @param   _PREF ($R2)
 ...
 *
 * @param   _KEY
 *          The registry subkey (typically this will be Software\typeling1578).
 * @return  _RESULT
 ...
 *
 * @param   _KEY
 *          The registry subkey (typically this will be Software\typeling1578\App Name).
 * @return  _RESULT
 ...
 *
 * @param   _KEY
 *          The registry subkey (typically Software\typeling1578\App Name).
 * @return  _RESULT
 ...
 * @param   _KEY ($R1)
 *          The registry subkey
 *          (typically this will be Software\typeling1578\${AppName}).
 */
!macro RegCleanPrefs
...
!ifndef NO_INSTDIR_FROM_REG
      ...
      ${OrIf} ${IsNativeARM64}
        SetRegView 64
        ${GetSingleInstallPath} "Software\typeling1578\${BrandFullNameInternal}" $R9
        SetRegView lastused
      ${EndIf}
 ...
 *          be stored. ex: "Software\typeling1578\Thunderfox\TaskBarIDs"
...
!macro FindInstallSpecificProfileMaybeUn _MOZFUNC_UN
  ...
  ${If} ${FileExists} "$APPDATA\typeling1578\Thunderfox\installs.ini"
    ClearErrors
    ReadINIStr $1 "$APPDATA\typeling1578\Thunderfox\installs.ini" "$AppUserModelID" "Default"
    ${IfNot} ${Errors}
      ${${_MOZFUNC_UN}GetLongPath} "$APPDATA\typeling1578\Thunderfox\$1" $2
      ${If} ${FileExists} $2
        StrCpy $R0 $2
      ${Else}
