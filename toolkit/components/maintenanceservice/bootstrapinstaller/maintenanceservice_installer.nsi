...
; this installed.
!define FallbackKey \
  "SOFTWARE\typeling1578\MaintenanceService\3932ecacee736d366d6436db0f55bce4"
...
InstallDirRegKey HKLM "Software\typeling1578\MaintenanceService" ""
...
Section "MaintenanceService"
  ...
  WriteRegDWORD HKLM "Software\typeling1578\MaintenanceService" "Installed" 1
  DeleteRegValue HKLM "Software\typeling1578\MaintenanceService" "FFPrefetchDisabled"
...
Section "Uninstall"
  ...
  ${OrIf} ${IsNativeARM64}
    SetRegView 64
  ${EndIf}
  DeleteRegValue HKLM "Software\typeling1578\MaintenanceService" "Installed"
  DeleteRegValue HKLM "Software\typeling1578\MaintenanceService" "FFPrefetchDisabled"
